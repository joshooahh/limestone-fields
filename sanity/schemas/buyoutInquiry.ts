    ...
    defineField({
      ...
      options: {
        list: [
          ...
          { title: 'Small Wedding (landing page)', value: 'small_wedding' },
          { title: 'Company Retreat (landing page)', value: 'company_retreat' },
          { title: 'Family Reunion (landing page)', value: 'family_reunion' },
